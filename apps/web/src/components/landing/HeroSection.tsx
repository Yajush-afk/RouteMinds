    ...
    className="bg-[#F5F5F0] px-8 md:px-16 lg:px-24 flex flex-col justify-start pt-28 pb-20"    >
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-[#8B7D3A] leading-tight">
              Start Predicting.
            </h1>
          </div>

          {/* Description */}
          <p className="text-[#555] text-lg max-w-md leading-relaxed -mt-2">
        ...
        <div className="bg-[#1a1a1a] rounded-2xl p-6 text-white space-y-6 shadow-2xl">
          <p className="text-xs tracking-widest uppercase text-gray-400">
            Route and Prediction
          </p>
          <div>
            <p className="text-4xl font-bold">12m Delay</p>
          ...
          <div className="border-t border-gray-700 pt-4">
            ...
            <p className="text-5xl font-bold text-green-400 mt-1">94.4%</p>
          </div>
        </div>
