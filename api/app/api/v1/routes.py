...
async def optimize_route(
    ...
    return RouteOptimizationResponse(
        ...
        total_in_vehicle_minutes=result.total_in_vehicle_minutes,
        transfer_count=result.transfer_count,
        fragile_transfer_count=result.fragile_transfer_count,
        transfer_fragility_score=result.transfer_fragility_score,
        congestion_proxy_ratio=result.congestion_proxy_ratio,
